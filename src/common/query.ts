...
export class postQueryString {
	...
	public static readonly findOne =
		"SELECT * FROM `Capstone2021`.`Posts` WHERE `idx`=?;";
	public static readonly updateOne =
		"UPDATE `Capstone2021`.`Posts` SET `user_id` = ? `postContent` = ? WHERE (`idx` = ?);";
	public static readonly createOne =
		"INSERT INTO `Capstone2021`.`Posts` (`user_id`, `postContent`) VALUES (?, ?);";
	public static readonly deleteOne =
		"DELETE FROM `Capstone2021`.`Posts` WHERE (`idx` = ?);";
}
...
export class commentQueryString {
	...
	// public static readonly findOne =
	// 	"SELECT * FROM `Capstone2021`.`Comments ` WHERE `idx`=?;";
	public static readonly updateOne =
		"UPDATE `Capstone2021`.`Comments` SET `user_id` = ?, `post_id` = ?, `commentText` = ? WHERE (`idx` = ?);";
	public static readonly createOne =
		"INSERT INTO `Capstone2021`.`Comments` (`user_id`, `post_id`, `commentText`) VALUES (?, ?, ?);";
	public static readonly deleteOne =
		"DELETE FROM `Capstone2021`.`Comments` WHERE (`idx` = ?);";
}
